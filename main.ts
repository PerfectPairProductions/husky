scene.onHitWall(SpriteKind.Player, function (sprite, location) {
    if (tiles.tileAtLocationIsWall(tiles.getTileLocation(0, 0))) {
        left_wall_column = 1
        scene.setBackgroundImage(assets.image`twn_market`)
        mySprite.setPosition(159, 104)
        right_wall_column = 0
    } else {
        if (tiles.tileAtLocationIsWall(tiles.getTileLocation(0, 0))) {
            left_wall_column = 1
...
let right_wall_column = 0
let left_wall_column = 0
...
game.setGameOverMessage(true, "Happy Retirement Ray!!")
